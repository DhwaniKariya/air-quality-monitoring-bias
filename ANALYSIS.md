...
climbs from **19.8%** in the least diverse quartile up to **41.4%** in the third quartile,
dipping slightly to **38.3%** in the most diverse quartile, meaning more diverse counties
generally appear better monitored. That turned out to be misleading once I weighted by
population instead of just counting counties (more on that below).
